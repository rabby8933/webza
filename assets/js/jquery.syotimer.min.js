...
! function(i, e) {
    ...
    var m = "day",
        ...
        c = {
            ...
            _applyEffectSwitch: function(e, t) {
                ...
                }, 1e3) : "opacity" !== e || (i = o.data("syotimer-items")[t]) && (o = d.next(t), t = i.data("syotimer-unit-value"), l(".syotimer-cell__value", i).animate({
                    opacity: .1
                }, 1e3, "linear", function() {
                    c._perSecondHandler.apply(n, [])
    ...
    l.fn.syotimer = function(e) {
        ...
        rusNumeral: function(e) {
            e = 4 < e % 100 && e % 100 < 20 ? 2 : [2, 0, 1, 1, 1, 2][e % 10 < 5 ? e % 10 : 5];
            return e
        },
        getNumeral: function(e, t, i) {
            e = this[l.syotimerLang[t].handler || "universal"](e);
            return l.syotimerLang[t][i][e]
        }
    }
}, window.jQuery);